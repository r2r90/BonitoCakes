...
const Home = () => {
  ...
  const categories = ['Wedding', 'Anniversary', 'Christening', 'For Boys', 'For Girls', 'Pies'];
  ...
  }, [dispatch, alert, keyword, currentPage, price, category, rating, error]);
          ...
          <section id="products" className="container mt-5">
            ...
            <div className="row">
              {keyword ? (
                ...
                products &&
                products.map((product) => <Product product={product} key={product._id} col={3} />)
              )}
            </div>
          </section>
          {resPerPage <= count && (
